...
from send_email.gmail_info import GmailLogin

class SendEmail(GmailInfo):
    def __init__(self, property_website):
        self._gmail_user = GmailLogin.gmail_user
        self._gmail_password = GmailLogin.gmail_password
        self._from_addr = GmailLogin.from_addr
        self._bcc_addr = GmailLogin.bcc_addr
        self._to_addr = GmailLogin.to_addr
